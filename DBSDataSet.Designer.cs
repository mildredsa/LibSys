...
namespace LibSys.DBSDataSetTableAdapters {
...
SELECT AccessionNumber, Title, Author, Status, Inventory FROM Books WHERE (AccessionNumber = @AccessionNumber)";
        ...
        public virtual int Fill(DBSDataSet.BooksDataTable dataTable) {
        ...
        public virtual DBSDataSet.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBSDataSet.BooksDataTable dataTable = new DBSDataSet.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBSDataSet.BooksDataTable dataTable) {
